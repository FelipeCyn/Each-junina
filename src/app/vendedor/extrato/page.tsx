...
export default async function VendedorExtratoPage() {
    ...
    <div className="min-h-screen bg-white flex flex-col">
      <header className="bg-red-600 px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <a href="/vendedor" className="text-red-200 hover:text-white font-black text-sm transition-colors">
            ← Voltar
          </a>
          <div>
            <h1 className="text-white font-black text-lg leading-tight">🎪 MEU EXTRATO</h1>
